	...
	protected function render($settings = array(), $inner_content = ''){
		...
		<style scoped>
			...
			#'.$id.' .dl-menuwrapper button svg line{
				'.((isset($color) && ($type=='mobilemenu')) ? "stroke:".esc_attr($color).";" : "").'
			}
		...
		if($type=='favorite'){
			...
			$out .= '<div class="celldisplay rh-search-icon rh-header-icon text-center"><span class="icon-search-onclick cursorpointer" aria-label="Search"></span></div>';
		}
