...
<?php } if(!$_G['setting']['bbclosed'] && !$_G['member']['freeze'] && $_G['member']['groupid'] != 5) { if($_G['uid'] && !isset($_G['cookie']['checkpm'])) { ?>
...
<?php } if(!$_G['setting']['bbclosed'] && !$_G['member']['freeze'] && $_G['member']['groupid'] != 5 && $_G['setting']['disableipnotice'] != 1 && $_G['uid'] && !empty($_G['cookie']['lip'])) { ?>
<div class="focus plugin" id="ip_notice"></div>
<script type="text/javascript">ipNotice();</script>
<?php } if($_G['member']['newprompt'] && (empty($_G['cookie']['promptstate_'.$_G['uid']]) || $_G['cookie']['promptstate_'.$_G['uid']] != $_G['member']['newprompt']) && $_GET['do'] != 'notice' && !$_G['member']['freeze'] && $_G['member']['groupid'] != 5) { ?>
<script type="text/javascript">noticeTitle();</script>
<?php } if(($_G['member']['newpm'] || $_G['member']['newprompt']) && empty($_G['cookie']['ignore_notice']) && !$_G['member']['freeze'] && $_G['member']['groupid'] != 5) { ?>
