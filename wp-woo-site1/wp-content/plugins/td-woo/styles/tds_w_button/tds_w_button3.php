...
class tds_w_button3 extends td_style {
    ...
    private function get_css() {
		...
		$raw_css =
			"<style>
				...
				/* @specific_style */
				body.woocommerce div.tds-w-button3 .tdw-btn,
				body.woocommerce div.tds-w-button3 form.variations_form .single_add_to_cart_button {
				...
				body.woocommerce div.tds-w-button3 .tdw-btn,
				body.woocommerce div.tds-w-button3 form.variations_form .single_add_to_cart_button,
				body.woocommerce div.tds-w-button3 form.variations_form .single_add_to_cart_button:hover {
				    color: #000;
				}
                body.woocommerce div.tds-w-button3 svg,
                body.woocommerce div.tds-w-button3 svg * {
                    fill: #000;
                }
				body.woocommerce div.tds-w-button3 .tdw-btn:before,
				body.woocommerce div.tds-w-button3 form.variations_form .single_add_to_cart_button:before {
                    content: '';
                    width: 100%;
                    height: 100%;
				    background-color: #fff;
				...
				body.woocommerce div.tds-w-button3 .tdw-btn:hover:before,
				body.woocommerce div.tds-w-button3 form.variations_form .single_add_to_cart_button:hover:before {
                    opacity: 1;
                }
				...
				/* @shadow */
				.$unique_block_class .tdw-btn,
				body.woocommerce div.$unique_block_class form.variations_form .single_add_to_cart_button {
					box-shadow: @shadow;
				}
				/* @shadow_hover */
				.$unique_block_class .tdw-btn:hover,
				body.woocommerce div.$unique_block_class form.variations_form .single_add_to_cart_button:hover {
