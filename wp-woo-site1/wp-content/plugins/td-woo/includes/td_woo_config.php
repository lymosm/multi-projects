	...
	static function td_woo_attribute_filter_attributes_settings() {
        ...
        if ( !empty( $taxonomies ) && is_array( $taxonomies ) ) {
            ...
            foreach ( $taxonomies as $taxonomy ) {
	            ...
	            $tax_label = isset( $taxonomy->attribute_label ) ? $taxonomy->attribute_label : ( isset( $taxonomy->label ) ? $taxonomy->label : '' );
	            ...
	            if ( $tax_name === 'product_cat' ) {
		            ...
		            $settings[] = array(
			            "param_name" => strtolower($tax_name) . "_type_action",
			            "type" => "dropdown",
			            "value" => array(
				            'Single selection - Default' => 'single_selection',
				            'Multiple selection' => 'multiple_selection',
			            ),
			            "heading" => 'Product categories filter type',
			            "description" => "Single selection - filter products just from the selected category.
OR
Multiple selection - filter products from multiple categories based on selection.",
			            "holder" => "div",
			            "class" => "tdc-dropdown-big",
			            "group" => "",
		            );
	...
	/**
	 * product attributes strat values array ( used by td_woo_add_to_cart shortcode )
	 *
	 * @return array
	 */
