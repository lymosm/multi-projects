...
INSERT INTO `shop`.`s_product_img`(`id`, `product_id`, `name`, `uri`, `sort`, `is_main`, `added_by`, `added_date`, `updated_by`, `updated_date`) VALUES (1, 1, '88.jpg', '/storage/images/20220418/1.jpg', 0, 1, 0, NULL, 0, NULL);
